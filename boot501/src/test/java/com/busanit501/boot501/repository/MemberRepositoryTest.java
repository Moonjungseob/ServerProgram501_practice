...
public class MemberRepositoryTest {
    ...
    public void testRead(){
        ...
        log.info("MemberRepositoryTest testRead, member" + member);
        log.info("MemberRepositoryTest testRead, member.getRoleSet" + member.getRoleSet());

        member.getRoleSet().forEach(memberRole -> {
            log.info("MemberRepositoryTest testRead, memberRole" + memberRole);
        });
    }
}
